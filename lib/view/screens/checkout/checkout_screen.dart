                ...
                children: [
                  ...
                  Container(
                    ...
                    child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: () {
                      ...
                      if(!_isCashOnDeliveryActive && !_isDigitalPaymentActive) {
                      ...
                      }else if(_orderAmount < storeController.store.minimumOrder) {
                        ...
                        orderController.placeOrder(PlaceOrderBody(
                          ...
                          discountAmount: _discount, taxAmount: _tax, receiverDetails: null, parcelCategoryId: null, chargePayer: null,
                        ), _callback);
                      }
