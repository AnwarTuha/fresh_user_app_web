      ...
      child: Scaffold(
        ...
        body: GetBuilder<OrderController>(builder: (orderController) {
          ...
          return orderController.orderDetails != null ? Column(children: [
              ...
              child: SizedBox(
                ...
                child: Row(children: [
                  ...
                  || _order.orderStatus == 'processing' || _order.orderStatus == 'handover'|| _order.orderStatus == 'picked_up') ? Expanded(
                    child: CustomButton(
                      buttonText: _parcel ? 'track_delivery'.tr : 'track_order'.tr,
                  ...
                  _order.orderStatus == 'pending' ? Expanded(child: Padding(
                    ...
                    child: TextButton(
                      ...
                      child: Text(_parcel ? 'cancel_delivery'.tr : 'cancel_order'.tr, style: robotoBold.copyWith(
            ...
            (_order.orderStatus == 'delivered' && (_parcel ? _order.deliveryMan != null : orderController.orderDetails[0].itemCampaignId == null)) ? Center(
              child: Container(
                width: Dimensions.WEB_MAX_WIDTH,
                padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                child: CustomButton(
                  ...
                  onPressed: () {
                    ...
                    Get.toNamed(RouteHelper.getReviewRoute(), arguments: RateReviewScreen(
                      orderDetailsList: _orderDetailsList, deliveryMan: _order.deliveryMan, orderID: _order.id,
                    ));
                  },
                ),
              ),
