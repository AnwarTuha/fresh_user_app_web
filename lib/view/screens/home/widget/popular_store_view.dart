...
class PopularStoreView extends StatelessWidget {
  ...
  PopularStoreView({@required this.storeController, @required this.isPopular, @required this.isFeatured});
                  ...
                  child: Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Stack(children: [
                        ...
                        DiscountTag(
                          discount: _storeList[index].discount != null
                              ? _storeList[index].discount.discount : 0,
                          discountType: 'percent', freeDelivery: _storeList[index].freeDelivery,
                        ),
                        (_storeList[index].open == 1 && _storeList[index].active) ? SizedBox() : NotAvailableWidget(isStore: true),
                        Positioned(
