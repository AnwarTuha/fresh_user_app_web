  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      GetBuilder<BannerController>(builder: (bannerController) {
        return bannerController.featuredBannerList == null ? BannerView(
          bannerController: bannerController, bannerList: bannerController.featuredBannerList,
          bannerDataList: bannerController.featuredBannerDataList, isFeatured: true,
        ) : bannerController.featuredBannerList.length == 0 ? SizedBox() : BannerView(
          bannerController: bannerController, bannerList: bannerController.featuredBannerList,
          bannerDataList: bannerController.featuredBannerDataList, isFeatured: true,
        );
      }),
            ...
            child: Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                ClipRRect(
                  ...
                  child: CustomImage(
                    image: '${splashController.configModel.baseUrls.moduleImageUrl}/${splashController.moduleList[index].thumbnail}',
                    height: 50, width: 50,
                  ),
                ),
      ...
      GetBuilder<StoreController>(builder: (storeController) {
        return storeController.featuredStoreList == null ? PopularStoreView(
          storeController: storeController, isPopular: false, isFeatured: true,
        ) : storeController.featuredStoreList.length == 0 ? SizedBox() : PopularStoreView(
          storeController: storeController, isPopular: false, isFeatured: true,
        );
      }),
